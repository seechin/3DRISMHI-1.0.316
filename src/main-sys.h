...
class IET_Param {
 ...
 // Fixed parameters
  public:   // task params
    ...
    int nt, ntf; bool mp_by_fork; int nice_level; pid_t pid; //int mp_tasks[MAX_THREADS];
 ...
 // SCF Iteration parameters
  public:   // RISM params
    ...
    double renorm_coulomb_scaling[MAX_SOL], renorm_lj_scaling[MAX_SOL];
  public:   // HI params
    int stepmax_hi;
  ...
  public:   // other flags
    bool b_save_original_xvv, b_output_filename_autogenerated;
 // ------------------------------------------
 // ------------------------------------------
 // ------------------------------------------
 // ------------------------------------------
  public:
    void init(int _argc, char ** _argv){
        ...
        nt = 1; ntf = 1; nice_level = 0; pid = getpid(); // for (int i=0; i<MAX_THREADS; i++) mp_tasks[i] = 0;
        ...
        for (int i=0; i<MAX_SOL; i++){ renorm_coulomb_scaling[i] = 1; renorm_lj_scaling[i] = 1; }
        ...
        detail_level = 1; debug_level = 0; mode_test = false; ignore_memory_capacity = false; debug_show_crc = false;
       #ifdef _INTERACTIVE_
